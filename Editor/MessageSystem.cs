...
namespace AssetBundleBrowser
{
    internal class MessageSystem
    {
        ...
        private static void InitMessages()
        {
            ...
            s_MessageLookup.Add(MessageFlag.Imposter, new Message("This is an imposter bundle. It won't be exported - only used as a dependency pointer to the original game files.", MessageType.Info));
